...
\umlusecase[x=2, y=1, width=5cm]{Visualizza posizione}
\umlusecase[x=2, y=0.2, width=5cm]{Controllo Eccesso Velocità}
\umlusecase[x=2, y=-0.4, width=5cm]{Consultazione Storico Furti}
\umlusecase[x=2, y=-1.2, width=5cm]{Riproduzione Video}
\umlusecase[x=2, y=-2, width=5cm]{Visualizzazione Informazioni}
...
\umlassoc{Amministratore}{usecase-19}
